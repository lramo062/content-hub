...
var G__34671 = o;
(G__34671[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
while (G__34673__i < G__34673__a.length) {G__34673__a[G__34673__i] = arguments[G__34673__i + 0]; ++G__34673__i;}
  args = new cljs.core.IndexedSeq(G__34673__a,0,null);
} 
...
var G__34675 = o;
(G__34675[reagent.impl.template.cached_custom_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
var G__34680 = props;
var G__34680__$1 = ((((!((id == null))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__34680,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__34680);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__34680__$1,new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var old_class = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__34681){
...
var props = map__34682__$1;
var class$ = cljs.core.get.call(null,map__34682__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
if(cljs.core.coll_QMARK_.call(null,class$)){
return cljs.core.assoc.call(null,props,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.call(null," ",cljs.core.keep.call(null,((function (map__34682,map__34682__$1,props,class$){
return (function (c){
...
});})(map__34682,map__34682__$1,props,class$))
,class$)));
} else {
return props;
}
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__34684){
...
var on_write = cljs.core.get.call(null,map__34685__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return reagent.impl.batching.do_after_render.call(null,((function (node_value,map__34685,map__34685__$1,on_write){
return (function (){
return reagent.impl.template.input_component_set_value.call(null,component);
});})(node_value,map__34685,map__34685__$1,on_write))
);
} else {
...
var G__34688 = jsprops;
(G__34688["defaultValue"] = value);

(G__34688["onChange"] = ((function (G__34688,v,value,on_change){
return (function (p1__34687_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__34687_SHARP_);
});})(G__34688,v,value,on_change))
);
...
var vec__34691 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__34691,(0),null);
var id = cljs.core.nth.call(null,vec__34691,(1),null);
var class$ = cljs.core.nth.call(null,vec__34691,(2),null);
...
var jsprops = ({"argv": v});
var temp__5461__auto___34695 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__5461__auto___34695 == null)){
} else {
var key_34696 = temp__5461__auto___34695;
(jsprops["key"] = key_34696);
}
...
var temp__5461__auto___34697 = reagent.impl.template.key_from_vec.call(null,argv);
if((temp__5461__auto___34697 == null)){
} else {
var key_34698 = temp__5461__auto___34697;
reagent.impl.template.oset.call(null,jsprops,"key",key_34698);
}
...
var G__34699 = reagent.impl.template.__GT_NativeWrapper.call(null);
(G__34699["name"] = c);
...
var len__4531__auto___34704 = arguments.length;
var i__4532__auto___34705 = (0);
while(true){
if((i__4532__auto___34705 < len__4531__auto___34704)){
args__4534__auto__.push((arguments[i__4532__auto___34705]));

var G__34706 = (i__4532__auto___34705 + (1));
i__4532__auto___34705 = G__34706;
continue;
} else {
}
break;
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq34702){
var G__34703 = cljs.core.first.call(null,seq34702);
var seq34702__$1 = cljs.core.next.call(null,seq34702);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__34703,seq34702__$1);
});
...
break;
default:
var G__34709 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
v = G__34709;
continue;
...
var n__4408__auto___34711 = a.length;
var i_34712 = (0);
while(true){
if((i_34712 < n__4408__auto___34711)){
(a[i_34712] = reagent.impl.template.as_element.call(null,(a[i_34712])));
...
var a = cljs.core.into_array.call(null,s);
var n__4408__auto___34714 = a.length;
var i_34715 = (0);
while(true){
if((i_34715 < n__4408__auto___34714)){
var val_34716 = (a[i_34715]);
if(((cljs.core.vector_QMARK_.call(null,val_34716)) && ((reagent.impl.template.key_from_vec.call(null,val_34716) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_34715] = reagent.impl.template.as_element.call(null,val_34716));

var G__34717 = (i_34715 + (1));
i_34715 = G__34717;
continue;
} else {
}
...
var ctx = ({});
var vec__34718 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__34718,(0),null);
var derefed = cljs.core.nth.call(null,vec__34718,(1),null);
...
var G__34721 = (cljs.core.count.call(null,argv) - first_child);
switch (G__34721) {
case (0):
...
break;
default:
return reagent.impl.template.global$module$react.createElement.apply(null,cljs.core.reduce_kv.call(null,((function (G__34721){
...
//# sourceMappingURL=template.js.map?rel=1539627754508
