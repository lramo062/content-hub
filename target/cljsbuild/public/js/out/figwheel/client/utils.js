...
return (new CustomEvent(event_name,(function (){var obj42207 = {"detail":data};
return obj42207;
})()));
} else {
...
var f = (function (){var pred__42214 = cljs.core._EQ_;
var expr__42215 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__42214.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__42215))){
return ((function (pred__42214,expr__42215){
return (function (p1__42208_SHARP_){
return console.warn(p1__42208_SHARP_);
});
;})(pred__42214,expr__42215))
} else {
if(cljs.core.truth_(pred__42214.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__42215))){
return ((function (pred__42214,expr__42215){
return (function (p1__42209_SHARP_){
return console.debug(p1__42209_SHARP_);
});
;})(pred__42214,expr__42215))
} else {
if(cljs.core.truth_(pred__42214.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__42215))){
return ((function (pred__42214,expr__42215){
return (function (p1__42210_SHARP_){
return console.error(p1__42210_SHARP_);
});
;})(pred__42214,expr__42215))
} else {
return ((function (pred__42214,expr__42215){
return (function (p1__42211_SHARP_){
return console.log(p1__42211_SHARP_);
});
;})(pred__42214,expr__42215))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__42218){
var map__42219 = p__42218;
var map__42219__$1 = ((((!((map__42219 == null)))?(((((map__42219.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__42219.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__42219):map__42219);
var opts = map__42219__$1;
var eval_fn = cljs.core.get.call(null,map__42219__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__42221_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__42223,(0),null);
...
//# sourceMappingURL=utils.js.map?rel=1539627776876
