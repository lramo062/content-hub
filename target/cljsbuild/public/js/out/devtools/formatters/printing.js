...
var len__4531__auto___32602 = arguments.length;
var i__4532__auto___32603 = (0);
while(true){
if((i__4532__auto___32603 < len__4531__auto___32602)){
args__4534__auto__.push((arguments[i__4532__auto___32603]));

var G__32604 = (i__4532__auto___32603 + (1));
i__4532__auto___32603 = G__32604;
continue;
} else {
}
break;
...
/** @this {Function} */
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq32599){
...
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__32600,G__32601,seq32599__$2);
});
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__32605_SHARP_){
return !((cljs.core.meta.call(null,p1__32605_SHARP_) == null));
})))){
...
var markup_db = cljs.core.get.call(null,map__32606__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e32610){var _e__31588__auto__ = e32610;
return false;
}})();
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
...
}catch (e32612){var _e__31588__auto__ = e32612;
return false;
}}
})())){
...
var _STAR_current_state_STAR_32614 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__32615 = opts;
var map__32615__$1 = ((((!((map__32615 == null)))?(((((map__32615.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__32615.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__32615):map__32615);
var markup_db = cljs.core.get.call(null,map__32615__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_32614;
}});
...
;
var temp__5455__auto___32619 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5455__auto___32619)){
var managed_print_level_32620 = temp__5455__auto___32619;
var _STAR_print_level_STAR_32618_32621 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_32620;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_32618_32621,managed_print_level_32620,temp__5455__auto___32619,writer,opts,job_fn){
return (function (p1__32617_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__32617_SHARP_,null);
});})(_STAR_print_level_STAR_32618_32621,managed_print_level_32620,temp__5455__auto___32619,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_32618_32621;
}} else {
job_fn.call(null);
}
...
//# sourceMappingURL=printing.js.map?rel=1539627751378
