...
var o32471 = temp__5455__auto__;
var temp__5455__auto____$1 = (o32471["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o32472 = temp__5455__auto____$1;
return (o32472["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__31581__auto__ = f;
return (o__31581__auto__["toString"]).call(o__31581__auto__);
} else {
return "";
}
}catch (e32473){var _ = e32473;
return "";
}});
...
try{var o__31581__auto___32475 = t;
(o__31581__auto___32475["cljs$lang$ctorPrWriter"]).call(o__31581__auto___32475,t,writer);
}catch (e32474){var __32476 = e32474;
}
...
var char_code = (function (){var o__31581__auto__ = (new String(char$));
return (o__31581__auto__["charCodeAt"]).call(o__31581__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__31581__auto__ = String;
return (o__31581__auto__["fromCharCode"]).call(o__31581__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__32477 = num_code;
switch (G__32477) {
case (1):
return (185);
...
var o__31581__auto__ = String;
return (o__31581__auto__["fromCharCode"]).call(o__31581__auto__,superscript_code);
});
/**
...
}catch (e32479){var _e__31588__auto__ = e32479;
return false;
}})())){
...
var vec__32480 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__32480,(0),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var o32483 = temp__5455__auto__;
var temp__5455__auto____$1 = (o32483["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o32484 = temp__5455__auto____$1;
return (o32484["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4531__auto___32491 = arguments.length;
var i__4532__auto___32492 = (0);
while(true){
if((i__4532__auto___32492 < len__4531__auto___32491)){
args__4534__auto__.push((arguments[i__4532__auto___32492]));

var G__32493 = (i__4532__auto___32492 + (1));
i__4532__auto___32492 = G__32493;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__32487){
var vec__32488 = p__32487;
var ns_detector = cljs.core.nth.call(null,vec__32488,(0),null);
...
var G__32494 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__32495 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__32494;
remaining_tokens = G__32495;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq32485){
var G__32486 = cljs.core.first.call(null,seq32485);
var seq32485__$1 = cljs.core.next.call(null,seq32485);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__32486,seq32485__$1);
});
...
var vec__32499 = cljs.core.split_with.call(null,(function (p1__32498_SHARP_){
return cljs.core.not_EQ_.call(null,p1__32498_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__32499,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__32499,(1),null);
...
var vec__32502 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__32502,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__32502,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__32505 = cljs.core.rest.call(null,remaining_tokens);
var G__32506 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__32505;
name_tokens = G__32506;
continue;
} else {
...
var vec__32509 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__32509,(0),null);
var arity = cljs.core.nth.call(null,vec__32509,(1),null);
var vec__32512 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__32512,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__32512,(1),null);
var vec__32515 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__32515,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__32515,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__32515,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__32515,(3),null);
...
var vec__32521 = result;
var munged_ns = cljs.core.nth.call(null,vec__32521,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__32521,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__32521,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__32521,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__32521,(4),null);
var arity = cljs.core.nth.call(null,vec__32521,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__32525 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__32525,(0),null);
var args = cljs.core.nth.call(null,vec__32525,(1),null);
var vec__32528 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__32528,(0),null);
var name = cljs.core.nth.call(null,vec__32528,(1),null);
...
var G__32531 = (arity + (1));
var G__32532 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__32533){
var vec__32534 = p__32533;
var arity = cljs.core.nth.call(null,vec__32534,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__32534,(1),null);
...
return cljs.core.get.call(null,arities,p1__32537_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__32538_SHARP_);
...
var args__4534__auto__ = [];
var len__4531__auto___32545 = arguments.length;
var i__4532__auto___32546 = (0);
while(true){
if((i__4532__auto___32546 < len__4531__auto___32545)){
args__4534__auto__.push((arguments[i__4532__auto___32546]));

var G__32547 = (i__4532__auto___32546 + (1));
i__4532__auto___32546 = G__32547;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__32541){
var vec__32542 = p__32541;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__32542,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq32539){
var G__32540 = cljs.core.first.call(null,seq32539);
var seq32539__$1 = cljs.core.next.call(null,seq32539);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__32540,seq32539__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__32550__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__32550__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__32550__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__32550__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__32551 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__32551,(0),null);
var fn_name = cljs.core.nth.call(null,vec__32551,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__32551,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__32551,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__32551,(4),null);
var arity = cljs.core.nth.call(null,vec__32551,(5),null);
...
var o__31581__auto__ = f;
return (o__31581__auto__["getBasis"]).call(o__31581__auto__);
});
/**
...
}catch (e32555){var _e__31588__auto__ = e32555;
...
var G__32556 = (obj[cljs.core.first.call(null,path)]);
var G__32557 = cljs.core.rest.call(null,path);
obj = G__32556;
path = G__32557;
continue;
} else {
...
return (function (accum,p__32558){
var vec__32559 = p__32558;
var bit = cljs.core.nth.call(null,vec__32559,(0),null);
var protocol = cljs.core.nth.call(null,vec__32559,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__32562){
var vec__32563 = p__32562;
var ns = cljs.core.nth.call(null,vec__32563,(0),null);
var name = cljs.core.nth.call(null,vec__32563,(1),null);
var selector = cljs.core.nth.call(null,vec__32563,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__32568,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__32568,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__32568,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__32566_SHARP_){
return (obj[cljs.core.first.call(null,p1__32566_SHARP_)]);
});})(name,sorted_matches,vec__32568,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1539627751211
